...
public extension XADPlatform {
	@nonobjc class func extractResourceForkEntry(with dict: [XADArchiveKeys : Any], unarchiver: XADUnarchiver, toPath destpath: String) throws {
	...
	@nonobjc class func updateFileAttributes(atPath path: String, forEntryWith dict: [XADArchiveKeys : Any], parser: XADArchiveParser, preservePermissions preservepermissions: Bool) throws {
