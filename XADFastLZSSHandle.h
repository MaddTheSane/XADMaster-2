...
-(instancetype)initWithParentHandle:(CSHandle *)handle windowSize:(int)windowsize;
-(instancetype)initWithParentHandle:(CSHandle *)handle length:(off_t)length windowSize:(int)windowsize;
